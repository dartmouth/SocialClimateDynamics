...
rho = 0.5 # Proportion of total population in the rich group, between 0 and 0.5
...
h = 1 # Homophily parameter, between 0 and 1
d = 0 # Maximum cost of dissatisfaction, between 0 and 10
...
def heterogeneous_pop_model(Y, t, delay, Tv, Tc, fmax, alpha_r, delta, kappa, alpha_p0, xr0, xp0, ir0, ip0, rho, cr, cp, kr, kp, h, d, w, omega, dc, s):
    v, xp, xr = Y(t)
